...
COMPOUND_STRATEGY_ADDRESS= "0x76aFA2b8C29E1B277A3BB1CD320b2756c1674c91" 
...
def main():
    ...
    contract.addStrategy(AAVE_STRATEGY_ADDRESS, AAVE_MAX_STRATEGY_DEBT_RATIO, AAVE_STRATEGY_CONTRACTS, AAVE_STRATEGYY_CHECKDATA, AAVE_STRATEGYY_OFFSET, AAVE_STRATEGYY_CALCULATION, AAVE_CALCULATION_CONDITION,sender=account, gas_limit="1200000000000")
