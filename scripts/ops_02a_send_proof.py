...
def main():
    ...
    strat_number = program_output[2]
    print("Old alllocation:", program_output[3:3+strat_number])
    print("New alllocation:", program_output[3+strat_number+1:3+strat_number+1+strat_number])
