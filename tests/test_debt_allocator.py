...
def test_add_strategy_2(debt_allo, owner, strat, stratData1, stratData2):
    with reverts("FIRST_DATA"):
        debt_allo.addStrategy(([], [2], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
...
def test_update_strategy_1(debt_allo, owner2, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("Ownable: caller is not the owner"):
        debt_allo.updateStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 0, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]) ,sender=owner2)

def test_update_strategy_2(debt_allo, owner, strat, stratData1, stratData2):
    # debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("NO_STRATEGIES"):
        debt_allo.updateStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 0, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]) ,sender=owner)

def test_update_strategy_3(debt_allo, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("DATA"):
        debt_allo.updateStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [1, 1, 0], [4], [0,0,0,0]), 0, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]) ,sender=owner)

def test_update_strategy_4(debt_allo, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("INDEX_OUT_OF_RANGE"):
        debt_allo.updateStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 1, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]) ,sender=owner)
...
def test_update_strategy_6(debt_allo, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("CALLDATA"):
        debt_allo.updateStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 0, (2, [stratData1.address, stratData2.address], [RANDOM_SELECTOR, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]) ,sender=owner)



def test_update_strategy_7(debt_allo, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    tx = debt_allo.updateStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 0, (1, [stratData1.address], [SELECTOR_1], [[]], [0], 3, [0, 1, 0], 4, [0, 0, 0, 0]) ,sender=owner)
...
def test_remove_strategy_1(debt_allo, owner2, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("Ownable: caller is not the owner"):
        debt_allo.removeStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 0, sender=owner2)

def test_remove_strategy_2(debt_allo, owner, strat, stratData1, stratData2):
    # debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("NO_STRATEGIES"):
        debt_allo.removeStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 0, sender=owner)

def test_remove_strategy_3(debt_allo, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("DATA"):
        debt_allo.removeStrategy(([strat.address], [1], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 0, sender=owner)

def test_remove_strategy_4(debt_allo, owner, strat, stratData1, stratData2):
    debt_allo.addStrategy(([], [], [], [], [], [], [], [], [], []), strat.address, (2, [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], 3, [0, 1, 0], 4, [0,0,0,0]),sender=owner)
    with reverts("INDEX_OUT_OF_RANGE"):
        debt_allo.removeStrategy(([strat.address], [2], [stratData1.address, stratData2.address], [SELECTOR_1, SELECTOR_2], [[], []], [0, 0], [3], [0, 1, 0], [4], [0,0,0,0]), 1, sender=owner)
